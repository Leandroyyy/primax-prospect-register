    ...
    <li>
      <div className="flex-1 w-60 py-3 sm:px-4">
        <div className="flex flex-col justify-center items-center bg-[#404040] rounded-xl sm:w-full sm:h-48 sm:px-10 sm:justify-start">
          <p
            className={`bg-primaxBlue text-white font-bold w-full flex justify-center rounded-t-md sm:px-[6.5rem]`}
          >
            {props.name}
          </p>
          <small className="text-[#B3B3B3]">{props.area}</small>
          <div className="flex flex-col items-center pm-2 pt-1 sm:pt-4">
            <p className="text-[#D4D4D4] text-[0.7rem]">{props.activityDate}</p>
            ...
            <div className="mb-2 sm:mt-3">
              <button
                className="bg-primaxBlue text-white rounded-xl text-sm px-2 border-2
                    hover:bg-white hover:text-primaxBlue hover:border-2 hover:border-primaxBlue
                    "
              >
                Agendar
              </button>
